...
def update_messages(messages, card_selection, win, loss, total_earnings):
...
def main():
    ...
    while trials_played < trials_to_play:
        ...
        # get card selection with numpy
        card_selection = np.random.choice(['A', 'B', 'C', 'D'])
        ...
        # update messages
        updated_messages = update_messages(messages, card_selection, win, loss, total_earnings)
